...
if(dir=="west"){
pos.top=parseInt(_38b.css("top"))||0;
//pos.top=parseInt(_38b.css("top"))-30||0;
...
_377(_3a7);
//$("#west").parent().attr("style","z-index:999;top:40px;width:180px;");
//$("#west").height($("#west").height()+39);
});
}
function _3ad(){
var cc=$(_3a7);
...
if(_3a8=="west"&&_3a9.expandWest){//_3ae.top
return {collapse:{left:-p.panel("panel")._outerWidth(),top:40,height:_3ae.height},expand:{left:0}};
}else{
