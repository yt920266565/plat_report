...
public class SummaryHour {
     ...
     * uph
     */
    private Integer uphTotalCount;
    /**
     * uphPass数
     */
    private Integer uphPassCount;
    /**
     * 测试总数
     */
    ...
    public Integer getUphTotalCount() {
        return uphTotalCount;
    }

    public void setUphTotalCount(Integer uphTotalCount) {
        this.uphTotalCount = uphTotalCount;
    }

    public Integer getUphPassCount() {
        return uphPassCount;
    }

    public void setUphPassCount(Integer uphPassCount) {
        this.uphPassCount = uphPassCount;
    }
