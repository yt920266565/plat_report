...
public class SummaryDuty {
     ...
     * 复测良率(%)
     */
    private Float restestPassRatio;
    /**
     * 首测总数
     */
    ...
    public Float getRestestPassRatio() {
        return restestPassRatio;
    }

    public void setRestestPassRatio(Float restestPassRatio) {
        this.restestPassRatio = restestPassRatio;
    }
